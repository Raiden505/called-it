...
function supportedCountryCodes() {
  ...
  if (typeof supportedValuesOf === "function") {
    try {
      return supportedValuesOf("region").filter((value) => /^[A-Z]{2}$/.test(value));
    } catch {
...
export const countryOptions: CountryOption[] = supportedCountryCodes()
